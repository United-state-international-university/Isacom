    ...
    <div class="container">
        ...
        <div class="wrapper animated bounceInLeft">
            <div class="company-info">
                <ul>
                    <li><h1>IsacomGroup</h1></li>
                    <li><i class="fa fa-road"></i> Usiu road</li>
                    <li><i class="fa fa-phone"></i>+254 555 555 555</li>
                    <li><i class="fa fa-envelope"></i>Isacomgroup@test.com</li>
                </ul>
            </div>
            <div class="contact">
                <h3>Email Us</h3>
